...
tab_content = template_2.create_template(
    ...
    # widget_1_1_2=widget['label_cnt_telegrams'],
    # widget_1_1_3=widget['label_cnt_telegram_chats'],
    # widget_1_2_1=widget['graph_pie_msg_chanels'],
    # widget_2_1=widget['table_telegram_chats']
    )
